...
<body>
    ...
    <main class="main">
        ...
        // Нові
        $orders=mysql_query("SELECT o.id, o.name, o.surname, o.tel, o.email, o.status, s.model, s.type, s.cost, o.employee, o.newdate, o.procdate, o.donedate FROM orders o INNER JOIN services s ON o.service = s.id WHERE o.status = '1'");
