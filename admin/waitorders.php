...
<body>
    ...
    <main class="main">
        ...
        if($_SESSION['privs'] == '1') {
            $orders=mysql_query("SELECT o.id, o.name, o.surname, o.tel, o.email, o.status, s.model, s.type, s.cost, o.employee, o.newdate, o.procdate, o.donedate FROM orders o INNER JOIN services s ON o.service = s.id WHERE o.status = '2'");
        }
        else {
            $orders=mysql_query("SELECT o.id, o.name, o.surname, o.tel, o.email, o.status, s.model, s.type, s.cost, o.employee, o.newdate, o.procdate, o.donedate FROM orders o INNER JOIN services s ON o.service = s.id WHERE o.status = '2' && o.employee = '{$_SESSION['id']}'");
        }
