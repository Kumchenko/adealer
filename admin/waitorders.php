...
<body>
        ...
        <div class="nav-bar-wrapper">
            <div class="nav-bar">
                ...
                <div class="nav-pages">
                    ...
                    <a href="waitorders.php" id="nav-active-page">В процесі</a>
    ...
    <main class="main">
        ...
        if($_SESSION['privs'] == '1') {
            $orders=mysqli_query($connect, "SELECT o.id, o.name, o.surname, o.tel, o.email, o.status, s.model, s.type, s.cost, o.employee, o.newdate, o.procdate, o.donedate FROM orders o INNER JOIN services s ON o.service = s.id WHERE o.status = '2'");
        }
        else {
            $orders=mysqli_query($connect, "SELECT o.id, o.name, o.surname, o.tel, o.email, o.status, s.model, s.type, s.cost, o.employee, o.newdate, o.procdate, o.donedate FROM orders o INNER JOIN services s ON o.service = s.id WHERE o.status = '2' && o.employee = '{$_SESSION['id']}'");
        }
